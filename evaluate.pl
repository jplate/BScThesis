...
% Prüft, ob das Auswertungsprogramm geschrieben und gelesen werden kann.
...
% Prüft, ob das Lisp-Hilfsprogramm existiert und lesbar ist
...
% Hilfsprädikat von eval_exercise. Schreibt eine Lisp-Datei, bei deren Laden
